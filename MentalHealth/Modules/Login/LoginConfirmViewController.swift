...
final class LoginConfirmViewController: BaseViewController {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            infoStackView.leadingAnchor.constraint(greaterThanOrEqualTo: containerView.leadingAnchor, constant: 16),
            infoStackView.trailingAnchor.constraint(lessThanOrEqualTo: containerView.trailingAnchor, constant: -16),
            ...
            confirmTitleLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 40),
            confirmTitleLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -40),
