...
final class ForgotPasswordViewController: BaseViewController, UITextFieldDelegate {
    ...
    private func setupUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            forgotPasswordDescription.topAnchor.constraint(equalTo: forgotPasswordTitle.bottomAnchor, constant: 16),
            forgotPasswordDescription.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            forgotPasswordDescription.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20),
            ...
            emailSentLabel.topAnchor.constraint(equalTo: emailTextField.bottomAnchor, constant: 8),
            emailSentLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 40),
