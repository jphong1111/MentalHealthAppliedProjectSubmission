...
final class LoginEthnicityViewController: BaseViewController {
    ...
    private func setupUI() {
        ...
        createSelectButton(label: buttonOption.map { $0.localized.capitalizedEachWord() }, spacing: 10, constraintWith: ethnicityTitleLabel) { selectedButton, buttonEnabled in
