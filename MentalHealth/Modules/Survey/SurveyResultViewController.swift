...
// DangerView
    ...
    private func setupWarningView() {
        ...
        warningView.addBorderAndColor(color: SoliUColor.surveyWarningBackground, width: 1, corner_radius: 12)
    ...
    private func setupTooltips() {
            ...
            for (imageView, text) in tooltipsData {
                ...
                NSLayoutConstraint.activate([
                    ...
                    tooltipView.topAnchor.constraint(equalTo: targetImageView.bottomAnchor, constant: 8),
        ...
        private func createTooltipView(withText text: String) -> UIView {
            ...
            tooltipView.addBorderAndColor(color: SoliUColor.depressionColor, width: 1, corner_radius: 12)
    ...
    private func labelSetup() {
        myScoreLabel.font = SoliUFont.regular12
        allUserAverageLabel.font = SoliUFont.regular12
        depressionTitleLabel.font = SoliUFont.bold16
        anxietyTitleLabel.font = SoliUFont.bold16
        stressTitleLabel.font = SoliUFont.bold16
        socialMediaAddictionTitleLabel.font = SoliUFont.bold16
        lonelinessTitleLabel.font = SoliUFont.bold16
        hrqolTitleLabel.font = SoliUFont.bold16
        dangerLabel.font = SoliUFont.bold12
        meLabel.font = SoliUFont.bold12
        avgLabel.font = SoliUFont.bold12
