...
//    }()
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            logYourFeelingLabel.topAnchor.constraint(equalTo: welcomeView.bottomAnchor, constant: 40),

            emotionStackView.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            emotionStackView.topAnchor.constraint(equalTo: logYourFeelingLabel.bottomAnchor, constant: 20),
            emotionStackView.heightAnchor.constraint(equalToConstant: 72),
            emotionStackView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            emotionStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
