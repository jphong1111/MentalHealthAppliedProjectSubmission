...
final class DiarcyCell: UITableViewCell, CellReusable {
    ...
    func populate(myDiary: AdviceItem) {
        ...
        case .good:
            self.borderView.addBorderAndColor(color: SoliUColor.newSoliuBlue, width: 1, corner_radius: 8)
        case .bad:
            self.borderView.addBorderAndColor(color: SoliUColor.diaryRedBorder, width: 1, corner_radius: 8)
        }
    }
}
