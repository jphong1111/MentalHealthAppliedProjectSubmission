...
final class MyDiaryRecordViewController: BaseViewController {
    ...
    func setupInitalUI() {
        ...
        niceView.addBorderAndColor(color: SoliUColor.tabBarBorder, width: 1, corner_radius: 16)
        badView.addBorderAndColor(color: SoliUColor.tabBarBorder, width: 1, corner_radius: 16)
    }
    ...
    @objc func selectMyMood(_ sender: UITapGestureRecognizer) {
        ...
        case 0:
            selected = 0
            niceView.addBorderAndColor(color: SoliUColor.newSoliuBlue, width: 1, corner_radius: 16)
            badView.addBorderAndColor(color: SoliUColor.tabBarBorder, width: 1, corner_radius: 16)
        ...
        case 1:
            selected = 1
            niceView.addBorderAndColor(color: SoliUColor.tabBarBorder, width: 1, corner_radius: 16)
            badView.addBorderAndColor(color: .red, width: 1, corner_radius: 16)
            submitButton.backgroundColor = SoliUColor.diarySubmitButton
