...
public final class GridSectionViewController: BaseSectionViewController {
    ...
    func setupViews() {
        ...
        //Note(Ticket1)
        selfTestView.layer.borderColor = UIColor(hex: "E5E5E5").cgColor
        ...
        NSLayoutConstraint.activate([
            labelOne.topAnchor.constraint(equalTo: selfTestView.topAnchor, constant: 16),
            labelOne.leadingAnchor.constraint(equalTo: selfTestView.leadingAnchor, constant: 16),
        ...
        //Note(Ticket1)
        counselorView.layer.borderColor = UIColor(hex: "E5E5E5").cgColor
        ...
        NSLayoutConstraint.activate([
            labelTwo.topAnchor.constraint(equalTo: counselorView.topAnchor, constant: 16),
            labelTwo.leadingAnchor.constraint(equalTo: counselorView.leadingAnchor, constant: 16),
        ...
        NSLayoutConstraint.activate([
            labelThree.topAnchor.constraint(equalTo: viewThree.topAnchor, constant: 16),
            labelThree.leadingAnchor.constraint(equalTo: viewThree.leadingAnchor, constant: 16),
