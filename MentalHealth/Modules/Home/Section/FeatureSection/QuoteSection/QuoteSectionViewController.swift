...
final class QuoteSectionViewController: BaseSectionViewController {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            titleBackgroundView.topAnchor.constraint(equalTo: view.topAnchor, constant: 16),
            ...
            refreshButton.topAnchor.constraint(equalTo: view.topAnchor, constant: 16),
            ...
            titleLabel.leadingAnchor.constraint(greaterThanOrEqualTo: titleBackgroundView.leadingAnchor, constant: 8),
            titleLabel.trailingAnchor.constraint(lessThanOrEqualTo: titleBackgroundView.trailingAnchor, constant: -8),
            ...
            authorLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -16),
