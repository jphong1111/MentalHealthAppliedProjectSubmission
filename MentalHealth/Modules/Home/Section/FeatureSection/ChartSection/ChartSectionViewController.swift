...
class ChartSectionViewController: BaseSectionViewController {
    var stepCounts: [Int] = []
    //getting test result score
    var testResultCounts: [Int] = [4,1,2,0,2,3,4,1,0,3,2,4,5,4]
    var days: [String] = []
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            combinedChartView.topAnchor.constraint(equalTo: view.topAnchor, constant: 16),
            combinedChartView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 8),
            combinedChartView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -8),
            
            stepCircleView.topAnchor.constraint(equalTo: combinedChartView.bottomAnchor, constant: 8),
            stepCircleView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            stepCircleView.widthAnchor.constraint(equalToConstant: 8),
            stepCircleView.heightAnchor.constraint(equalToConstant: 8),
            
            stepConfigLabel.centerYAnchor.constraint(equalTo: stepCircleView.centerYAnchor),
            stepConfigLabel.leadingAnchor.constraint(equalTo: stepCircleView.trailingAnchor, constant: 8),
            
            mentalHealthCircleView.topAnchor.constraint(equalTo: stepCircleView.bottomAnchor, constant: 12),
            mentalHealthCircleView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            mentalHealthCircleView.widthAnchor.constraint(equalToConstant: 8),
            mentalHealthCircleView.heightAnchor.constraint(equalToConstant: 8),
            
            mentalHealthConfigLabel.centerYAnchor.constraint(equalTo: mentalHealthCircleView.centerYAnchor),
            mentalHealthConfigLabel.leadingAnchor.constraint(equalTo: mentalHealthCircleView.trailingAnchor, constant: 8),
            mentalHealthConfigLabel.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -16),
            
            //Right side step label
            stepCountStackView.centerYAnchor.constraint(equalTo: stepConfigLabel.centerYAnchor),
            stepCountStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            ...
            mentalScoreStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16)
        ])
    }
    
    private func updateChart() {
        var barChartDataEntries: [BarChartDataEntry] = []
        //나중에 해야: Connect with result data(need discuss)
        ...
        lineChartDataSet.circleRadius = 3 // Circle size
