...
extension SoliUColor {
    //Example
    static let neutralBlue = UIColor(hex: "#0075FF")
    static let calmPurple = UIColor(hex: "#6A5ACD")
    static let relaxingGreen = UIColor(hex: "#32CD32")
    static let warmOrange = UIColor(hex: "#FF8C00")
    static let soothingGray = UIColor(hex: "#A9A9A9")
    static let comfortYellow = UIColor(hex: "#FFD700")
}
